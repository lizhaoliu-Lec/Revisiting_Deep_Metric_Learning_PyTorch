    ...
    def compute_standard(self, opt, model, dataloader, evaltypes, device, **kwargs):
        ...
        for evaltype in evaltypes:
            ...
            for metric in self.list_of_metrics:
                ...
                if 'kmeans_nearest_cosine' in metric.requires:   input_dict[
                    'computed_cluster_labels_cosine'] = computed_cluster_labels_cosine
                if 'nearest_features_cosine' in metric.requires: input_dict[
                    'k_closest_classes_cosine'] = k_closest_classes_cosine
